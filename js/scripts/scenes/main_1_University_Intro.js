const main_1_University_Intro = {
  'main_1_University_Intro_start': [
    ...
    '<p class = "italicText">There was no way I would get to the university on time. So much for a good first day…</p>',
    ...
    'show scene cafe_exterior with fadeOut duration 1s',
    'wait 1000',
